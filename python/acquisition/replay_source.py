...
class ReplaySignalSource:
    ...
    def read(self):
        ...
        source_time_ms, value = self._rows[self._index]
        ...
        self._index += 1
        return SignalReading(host_time_ms=host_time_ms, signal_value=value)
    ...
    def _load_rows(self):
        with open(self.csv_file, "r", newline="") as file:
            ...
            for row in reader:
                try:
                    rows.append((float(row["time_ms"]), float(row[value_key])))
